...
base_url = "http://rss.sina.com.cn/rollnews/finance/"
...
def parse_result(html):
    ...
    if html is None or "item:[]" in html:
        return []
...
if __name__ == '__main__':
    ...
    start_date = setting.START_DATE_1
    end_date = setting.END_DATE_1
